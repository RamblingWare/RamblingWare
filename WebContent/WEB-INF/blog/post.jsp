...
<meta property="og:url" content="<%=Application.getString("url")%>/blog/<s:property value="post.uriName" />">
			...
			<div id="page-content" class="w3-col m8 l8 w3-container w3-padding">
				...
				<div class="w3-container w3-padding-0 w3-margin-0 w3-animate-opacity no-print">
					<div class="w3-padding-16 w3-center">
						...
						target="_Blank" href="https://www.facebook.com/sharer.php?u=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />"></a>				
						...
						target="_Blank" href="https://twitter.com/intent/tweet?url=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />"></a>
						...
						<a title="Share on LinkedIn" class="w3-btn w3-round-large w3-large w3-padding-square w3-hover-shadow w3-hover-blue-grey w3-theme-l4 icon-linkedin"
						 target="_Blank" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />'"></a>
						...
						<a title="Share on Google+" class="w3-btn w3-round-large w3-large w3-padding-square w3-hover-shadow w3-hover-red w3-theme-l4 icon-google"
						 target="_Blank" href="https://plus.google.com/share?url=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />'"></a>
						...
						<a title="Share on Reddit" class="w3-btn w3-round-large w3-large w3-padding-square w3-hover-shadow w3-hover-black w3-theme-l4 icon-reddit"
						 target="_Blank" href="https://www.reddit.com/submit?url=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />'"></a>
						...
						<a title="Email to a friend" class="w3-btn w3-round-large w3-large w3-padding-square w3-hover-shadow w3-hover-teal w3-theme-l4 icon-mail"
						 target="_Blank" href="mailto:?subject=Check%20out%20this%20<%=Application.getString("name")%>%20post&body=https%3A%2F%2F<%=Application.getString("domain")%>%2Fblog%2F<s:property value="post.uriName" />"></a>
					...
					<div id="share-popup" class="w3-modal">
						<div class="w3-modal-content page-half w3-theme-light w3-animate-top w3-card-16">
							<div class="w3-container w3-padding-8">
								...
								<input id="plink" name="plink" class="w3-input w3-round-large w3-border" onClick="this.setSelectionRange(0, this.value.length)" value="<%=Application.getString("url")%>/blog/<s:property value="post.uriName" />" type="text" /><br />
							</div>
						</div>
					</div>
				</div>
