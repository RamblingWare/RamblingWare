	...
	<article class="w3-theme-light">
		<div class="page w3-row">
			...
			<div id="page-content" class="w3-col m8 w3-container w3-padding">
				...
				Because this site is hosted by IBM Bluemix, it would be my recommendation to read <a target="_Blank" href="http://www.ibm.com/privacy">IBM's Privacy Policy</a> too.<br /><br />
				<span class="bold">Cookies.</span> This website may make use of cookies, but they are not necessary for using it. JavaScript is recommended, but its mainly used for Social Website sharing and links.<br /><br />
