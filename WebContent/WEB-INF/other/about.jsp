...
<title>About - <%=Application.getString("name")%></title>
</head>
	...
	<article class="w3-theme-light">
		<div class="page w3-row">
			...
			<div id="page-content" class="w3-col m8 l8 w3-container w3-padding">
				...
				<p>
					<%=Application.getString("name")%> is my blog about computers, programming, tech, and things that bother me. I hope it bothers you too.
					<br/><br/>
				...
				<a target="_blank" href="<%=Application.getString("sourceCode")%>">GitHub repo</a>. Or if you like this website and wanted to deploy your own using this code, you can do that too.
				</p>
				<p>
					<a class="w3-btn w3-card w3-round w3-light-grey" target="_blank" href="<%=Application.getString("sourceCode")%>/issues"><span class="icon-bug w3-large w3-margin-right"></span>Report Bug</a>
					&nbsp;&nbsp;
					<a class="w3-btn w3-card w3-round w3-light-grey" target="_blank" href="<%=Application.getString("sourceCode")%>"><span class="icon-embed w3-large w3-margin-right"></span>View Code</a>
				</p>
				...
				<h2>Contact</h2>
				<p>You can reach <%=Application.getString("name")%> via the social links on the bottom of every page, or send us an email at <a href="mailto:<%=Application.getString("email")%>"><%=Application.getString("email")%></a>.
