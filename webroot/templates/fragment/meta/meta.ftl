...
<meta name="application-name" content="${(context.name)!'Oddox'}"/>
<meta name="author" content="${(context.name)!'Oddox'}"/>
<meta name="keywords" content="${(context.keywords)!'oddox'}"/>
<meta name="description" content="${(context.description)!'description'}"/>
