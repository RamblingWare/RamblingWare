<div id="archive" class="three columns">
	<div class="margin">
		<#if context.archiveFeatured??>
			<h4 class="text-secondary">Featured</h4>
	...
	<div class="margin">
		<#if context.archiveYears??>
			<h4 class=""><a href="/year/" class="text-secondary">Years</a></h4>
	...
	<div class="margin">
		<#if context.archiveCategories??>
			<h4 class=""><a href="/category/" class="text-secondary">Categories</a></h4>
			<p class="margin-none">
	...
	<div class="margin">
		<#if context.archiveTags??>
			<h4 class=""><a href="/tag/" class="text-secondary">Tags</a></h4>
			<p class="margin-none">
